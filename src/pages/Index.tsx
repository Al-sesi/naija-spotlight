...
export default function Index() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden gradient-hero py-16 md:py-24 lg:py-32">
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold mb-6 leading-tight bg-gradient-to-r from-foreground via-foreground to-primary bg-clip-text text-transparent">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="text-base h-12 px-8 bg-card">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature, i) => (
              <Card key={i} className="p-6 md:p-8 hover:shadow-lg transition-all duration-300 group bg-card">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, i) => (
              <Card key={i} className="p-6 md:p-8 bg-card">
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-3xl p-8 md:p-12 lg:p-16 border border-primary/20">
